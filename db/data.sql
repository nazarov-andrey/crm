...
INSERT INTO `attachment` (`id`, `path`, `name`, `mime_type`, `owner`, `type`) VALUES (2,'/../private/attachments/0d46b120878cca86f1fd1bed1e93f9f7fbfcf307','Australia.png','image/png',7,'1'),(7,'/../private/attachments/67aee3e8657beb231a620cc76ee17609439a640e','Australia.gif','image/gif',3,'4'),(8,'/../private/attachments/f1978fbc9d455ea4db5b584adfb5d8c1a801bd42','Austria.png','image/png',11,'4');
...
INSERT INTO `attachment_type` (`id`, `code`) VALUES (1,'application'),(2,'organization'),(3,'person'),(4,'offer');
...
INSERT INTO `offer` (`id`, `org`, `app`, `offer_id`, `date`, `comment`, `legal_entity`) VALUES (3,34,7,'','2012-05-27','qweqweqweqwe\r\nqwe\r\nqw\r\neqzzzzzzzzzzzzz\r\nwe\r\nqwe',1),(4,34,2,'','2012-05-10','123123123',1),(5,34,2,'','2012-05-10','123123123',1),(6,34,2,'','2012-05-24','123',1),(8,34,7,'20001','2012-05-17','123',1),(9,34,7,'20002','2012-05-17','123',1),(10,37,8,'30001','2012-05-24','qwe\r\nqwe\r\nqwe\r\nqweqweqweqwe',2),(11,37,8,'30002','2012-05-10','qweqweqwe',2);
/*!40000 ALTER TABLE `offer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `offer_id`
--

LOCK TABLES `offer_id` WRITE;
/*!40000 ALTER TABLE `offer_id` DISABLE KEYS */;
INSERT INTO `offer_id` (`id`, `legal_entity`, `prefix`, `next_id`) VALUES (1,1,'2',3),(2,2,'3',3),(3,3,'1',1);
/*!40000 ALTER TABLE `offer_id` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `report` (`id`, `contact`, `date`, `comment`, `legal_entity`, `app`) VALUES (1,5,'2011-10-06',' CMS : aveva firmato con noi nel 2010 un contratto in fiera a Verona per una cnc 5 assi; poi perÃ² nel 2011 ha acquistato da Breton ( sono giÃ  clienti Bidese e probabilmente questa fusione li ha spinti a cambiare idea ). Sotto trovate vari contatti; io parlavo sempre con Roman Pasko che Ã¨ l\'unico che parlicchia anche inglese (anche se non molto).....so che volevano comprare anche un tornio probabilmente ( che gli abbiamo offerto ) e forse una waterjet.',2,0),(2,12,'2011-09-23','CMS: abbiamo incontrato il 23.09.11 presso la fiera di Verona questo nostro cliente russo con cui siamo da tempo in contatto per varie tecnologie.Il cliente ha una sua cava di pietra calcarea ed una fabbrica nella Repubblica del Daghestan (parte meridionale della Federazione Russa), con vecchie linee di lavorazione di produttori misti (vecchia linea modulmarmo della CAMMA di Mario Spadone anno 1996-1997, vecchia fresa sempre della CAMMA, macchine piÃ¹ recenti Bombieri ',2,0),(3,19,'2011-09-05','Ci hanno chiesto oggi una nostra offerta per una fresa a CN contornatrice con elettromandrino come la \"Contoursaw FR/NC\" della BRETON ',2,0),(4,21,'2011-09-05','Il cliente ha giÃ Â  una proposta per una OMAG \"Mill 98\" e, per essere competitivi con il prezzo, possiamo proporgli una CONCEPT 283 nella stessa configurazione della macchina giÃ  recentemente proposta alla STB OOO (Russia)',2,0),(5,22,'2011-09-05','interessato di equipment Maxima 5X CNC ',2,0),(6,24,'2011-08-31','haÂ chiesto se abbiamo disponibile un impianto water-jet usato e se possiamo anche proporre una macchina per \"engravings\", non crediamo un centro a CN completo, ma una piccola macchina a 3 assi per scrivere e fare piccoli bassorilievi.',2,0),(7,25,'2011-08-21','Aveva chiesto info per Maxima',2,0),(8,28,'2011-09-23','Ci sembra di aver capito che al cliente, forse anche per una questione di prezzo di investimento, potrebbe andare bene una macchina piÃ¹ semplice ed economica rispetto alla UNYKA, come una fresa con motore tradizionale che gli possa anche fare delle lavorazioni a CN con l\'albero in verticale e cambiando \"qualche\" utensile (vedi quali e quali lavorazioni possibili...) con un attacco conico ISO. Mi ha detto di avere giÃ  una fresa a CN, ma con banco rotante e piuttosto lenta (+ con problemi di software..) con la quale lui ha giÃ  fatto lavorazioni di engravings ed altre con utensili a CN applicati.',2,0),(9,30,'2011-09-23','HA ACQUISTATO UNA PRUSSIANI DI CUI PERO\' NON E\' ASSOLUTAMENTE CONTENTO',2,0),(10,32,'2011-09-23',' il cliente aspettava la finanziamento statale per questa macchina ancora fine 2010, ma ci sono i ritardi. Adesso dice che promettono il finanziamento in maggio 2011',2,0),(11,33,'2011-09-23','armeni, ma vivono a Mosca. PiÃ¹ di un anno siamo con loro in trattativa per le macchine grosse per taglio blocchi (Gaspari Menotti), adesso mi hanno detto che finiscono i loro lavori di preparazione nella fabbrica e in febbraio cercheranno di venire in Italia per discutere concretamente. Hanno anche detto che sono interessati nelle macchine tipa centri di lavoro. Quindi, adesso mando a loro la presentazione della CMS e delle macchine e quando arriveranno in febbraio, li porteremo in CMS.',2,0),(12,36,'2011-09-23','PER QUESTO CLIENTE AVEVAMO FATTO UNA DEMO IN CMS E SEMBRAVA CONVINTO...ASPETTAVA I FINANZIAMENTI PER ACQUISTARE CHE PERO\' NON HA POI PRESO',2,0),(16,96,'2012-05-31','123123123',1,7),(17,97,'2012-05-17','qwe',2,8);
...
-- Dump completed on 2012-05-23 18:10:53
